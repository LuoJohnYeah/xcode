<div class="widget widget-user" style="overflow: hidden">
    ...
    <div class="widget-user-header" style="{{ $style }}">
        <h3 class="widget-user-username">{{ $author or 'Luo' }}</h3>
        <h5 class="widget-user-desc">{{ $description or ' ' }}</h5>
    </div>
    <div class="widget-user-image">
        <img class="img-circle" src="{{ $avatar or 'http://tva4.sinaimg.cn/crop.0.0.996.996.180/006ykDYojw8fblv6vrt99j30ro0roabb.jpg' }}" alt="User Avatar">
    </div>
